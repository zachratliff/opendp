...
"functions": [
    ...
    { "name": "make_parse_column", "args": [ ["const char *", "selector"], ["const char *", "key"], ["bool", "impute"] ], "ret": "FfiTransformation *" },
    { "name": "make_select_column", "args": [ ["const char *", "selector"], ["const char *", "key"] ], "ret": "FfiTransformation *" },
