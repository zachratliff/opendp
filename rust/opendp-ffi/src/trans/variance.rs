...
use opendp::trans::{BoundedCovarianceConstant, BoundedVarianceConstant};
use opendp::trans;
...
pub extern "C" fn make_bounded_variance(
    ...
    fn monomorphize<T>(
        ...
        fn monomorphize2<MI, MO>(lower: MO::Distance, upper: MO::Distance, length: usize, ddof: usize) -> FfiResult<*mut FfiTransformation>
            ...
            trans::make_bounded_variance::<MI, MO>(lower, upper, length, ddof).into()
        }
    ...
    into_raw(dispatch!(monomorphize, [(type_output, @floats)], (type_args, lower, upper, length, ddof)))
}


#[no_mangle]
pub extern "C" fn make_bounded_covariance(
    type_args: *const c_char,
    ...
    fn monomorphize<T>(
        ...
        fn monomorphize2<MI, MO>(
            ...
            trans::make_bounded_covariance::<MI, MO>(lower, upper, length, ddof).into()
        }
    ...
    into_raw(dispatch!(monomorphize, [(type_args[2], @floats)], (type_args, lower, upper, length, ddof)))
}
