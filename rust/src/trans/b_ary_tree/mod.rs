...
impl<T, const P: usize> BAryTreeMetric for LpDistance<T, P> {}
    ...
    M::Distance: DistanceConstant<M::Distance> + InfCast<usize>,
{
    ...
    Ok(Transformation::new(
        ...
        M::default(),
        M::default(),
        StabilityRelation::new_from_constant(M::Distance::inf_cast(num_layers)?),
    ))
}
...
pub mod test_b_trees {
    use crate::{dist::L1Distance, meas::make_base_geometric};
